...
<!-- 右配置のボタンたち -->
		<div id="word_button">
			<a href="../word_graph/word_graph.php"><img src="../img/word_button.png" alt="word_link" width="43%" height="43%" ></img></a>
		</div>

		<div id="week_button">
			<a href="../week_graph/week_graph.php"><img src="../img/week_button.png" alt="word_link" width="37%" height="37%"></img></a>
		</div>
...
<!-- 左配置のボタンたち -->
		<div id="time_button">
			<a href="../time_graph/time_graph.php"><img src="../img/time_button.png" alt="word_link" width="40%" height="40%"></img></a>
		</div>

		<div id="history_button">
			<a href="../history/history_top.php"><img src="../img/走る.png" alt="word_link" width="200px" height="100px"></img>
			</a>
		</div>
<!-- ---------- -->
