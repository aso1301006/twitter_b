...
$con_fri_week1 = implode(",", $fri_week1);
...
$con_fri_week2 = implode(",", $fri_week2);
...
$con_fri_week3 = implode(",", $fri_week3);
...
$con_fri_week4 = implode(",", $fri_week4);
...
if($last_day>=funcDesignatedDay($n, $w)){
	...
	$con_fri_week5 = implode(",", $fri_week5);

}
else{$con_fri_week5="0";}
